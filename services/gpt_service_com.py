...
async def generate_gpt_response_com(user_name, values, assistant):
    ...
    prompt = (
        ...
        f"1) Для чего пара встретилась, Энергия {Y}\n"
        ...
        f"2) Как пара выглядит для других, Энергия {X}\n"
        ...
        f"3) Общая атмосфера внутри пары, Энергия {A}\n"
        ...
        f"4) Что укрепляет союз, Энергия {B}\n"
        ...
        f"8) Трудности и недопонимания, Энергия {C}\n"
