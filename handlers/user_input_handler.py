...
from services.gpt_service import EventHandler, generate_gpt_response, handle_gpt_response, setup_assistant_and_vector_store
...
async def process_selecting_category(callback_query: CallbackQuery, callback_data: CallbackData, state: FSMContext):
    ...
    if selected:
        ...
        response_text = await generate_gpt_response(user_name, values, assistant)
